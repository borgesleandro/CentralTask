$(document).ready(function () {
    ...
    $("#btnExportar").on("click", function () {
        ...
        xhr = $.ajax({
            type: 'POST',
            contentType: 'application/json',
            url: "DescontoSellOut/ExportarExcel",
            async: false,
            ...
            success: function (response, status, request) {
                ...
                setTimeout(function () { $("#exportarLinkDiv").html("<a href='" + downloadUrl + "' download='DescontoSellOut.xls' class=''><img src='Content/botao-salvar-download.png'/></a>") }, 2000);
