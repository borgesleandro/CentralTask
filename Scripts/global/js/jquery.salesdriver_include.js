...
includeJavaScript(includePath + 'core/hammer.js');
includeJavaScript(includePath + 'core/jquery.hammer.js');
includeJavaScript(includePath + 'core/jquery.salesdriver_core.js');
includeJavaScript(includePath + 'core/jquery.salesdriver_gesture.js');
includeJavaScript(includePath + 'core/jquery.specialevent.hammer.js');
includeJavaScript(includePath + 'core/jquery.salesdriver_gesture_conf.js');
...
includeJavaScript(includePath + 'patches.js');
